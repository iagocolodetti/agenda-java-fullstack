        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-center text-center">
                <div class="form-group col-xs-12 col-sm-10 col-md-8 col-lg-5">
                    <h4 class="mb-3 text-muted">Novo Usuário</h4>
                    <form class="card mb-4 justify-content-center" action="new" method="POST">
                        <div class="card-body">
                            ...
                            <label class="form-group has-float-label">
                                <input class="form-control" type="password" id="passwordConfirm" name="passwordConfirm" value="${passwordConfirm}" placeholder="Confirme a Senha" required />
                            ...
                            <div class="d-flex justify-content-between">
                                <a class="nav-link" href="${cp}/login">Já possui uma conta? Faça o Login.</a>
                                <input type="submit" class="btn btn-primary btn-fix" value="Criar conta" />
                            </div>
                        </div>
                    </form>
                </div>
